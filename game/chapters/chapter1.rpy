label chapter1:
    ...
    t_t smile "Свежий легкий ветер раздувал мои волосы, а солнце приятно грело лицо."
    ...
    #t neutral happy
    t happy "А я бы весь день играл и зарабатывал круглые суммы на фарме голды!"
    ...
    show h neutral
    t_t neutral "Хикару с серьезным лицом пытался понять, какие огрехи в конструкции мы допустили, и почему наш прототип не работает."
    ...
    #t smile/smug
    t_t smile "Я смотрел на это и думал: какие же у меня замечательные друзья."
    ...
    #t nervous
    t_t asharashen "Отец вошел в комнату и встал посередине, сложив руки в недовольном жесте."
    ...
    #t cry
    t_t cry_angry "С этой безумной, но по-своему гениальной идеей, а также слезами и соплями, растертыми по лицу, я сел делать уроки."
