...
t_t "Кацуми поставила бутылку воды на мой стол и встала рядом. Хикару занял место сбоку. Ден — как всегда, устроился задом наперёд на стуле передо мной."
...
t_t neutral "Дзиндзо точно так же пожал плечами и разделся."
...
t_t thinking thinking_hard "К жизни он в целом приспособлен. Для школы сойдёт — там моя репутация и без того ниже плинтуса."
...
d_t "...майнился биткоин для карманных расходов господина Тайды."
...
$ unlock_achievement(ACHIEVEMENT_GENIUS)
...
show k pose1 confused left at center with Dissolve(1)
...
k pose2 didnt_understand "В любой другой ситуации я бы не подпустила такого лентяя, как ты, и на 10 метров к моему коду. Но, возможно, мне действительно нужен взгляд со стороны."
