...
show expression "bush4" at Transform(xalign=-0.3, yalign=1.5), size_change(0.8, 0.8) onlayer screens zorder 100
...
k neutral "Так, все же понимают, что на данном этапе во всём признаваться - самоубийство."
