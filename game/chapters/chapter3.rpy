...
t_t thinking neutral "Ребята гуськом двинулись вдоль забора к выходу со двора, вскочили на велики и двинулись в сторону парка."
...
play music music_main_theme_3_v2 loop
...
t_t thinking thinking_hard "А также присутствовала определенная толика романтики — ведь что может быть лучше для пары школьников, чем совместное посещение аттракционов и мороженое в летнюю знойную жару?.."
