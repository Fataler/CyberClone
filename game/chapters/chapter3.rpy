...
t_t dissatisfied "Это привело меня в ярость и заставило осознать, что с этим точно необходимо что-то делать!"
pause 0.5
play sfx sfx_knock
...
t_t hz cry_sad "Я тихо подвывал от обиды и от того, как старые шорты сдавливали мои самые лучшие достоинства."
...
t_t "Юми засмущалась, но поблагодарила Дзиндзо, и они весело болтали, сидя на бортике фонтана и брызгая друг друга тёплой водичкой."
